...
class FunctionalTest(ptc.FunctionalTestCase):
    ...
    def test_forensic_bookkeeping(self):
        ...
        tile1 = self.folder.restrictedTraverse(
            '@@plone.app.tiles.demo.persistent/tile1')
        ITileDataManager(tile1).set({'message': u"First message",
                                     'counter': 1})
        notify(ObjectAddedEvent(tile1, self.folder, 'tile1'))

        # Also create two other tiles, for control purposes
        tile2 = self.folder.restrictedTraverse(
            '@@plone.app.tiles.demo.persistent/tile2')
        ITileDataManager(tile2).set({'message': u"Second message",
                                     'counter': 2})
        notify(ObjectAddedEvent(tile2, self.folder, 'tile2'))

        tile3 = self.folder.restrictedTraverse(
            '@@plone.app.tiles.demo.transient/tile3')
        ...
        tile2a = self.portal.restrictedTraverse(
            '@@plone.app.tiles.demo.persistent/tile2')
        ITileDataManager(tile2a).set({'message': u"Second message",
                                      'counter': 2})
        notify(ObjectAddedEvent(tile2a, self.portal, 'tile2'))

        tile4a = self.portal.restrictedTraverse(
            '@@plone.app.tiles.demo.persistent/tile4')
        ITileDataManager(tile4a).set({'message': u"Fourth message",
                                      'counter': 4})
        ...
        self.assertEquals([('tile1', 'plone.app.tiles.demo.persistent'),
                           ('tile2', 'plone.app.tiles.demo.persistent'),
                           ('tile3', 'plone.app.tiles.demo.transient')],
        ...
        self.assertEquals('plone.app.tiles.demo.persistent',
                          bookkeeping.typeOf('tile1'))
        self.assertEquals('plone.app.tiles.demo.persistent',
                          bookkeeping.typeOf('tile2'))
        self.assertEquals('plone.app.tiles.demo.transient',
                          bookkeeping.typeOf('tile3'))
        ...
        lostTileInstance = self.folder.restrictedTraverse(
            '@@%s/%s' % (lostTileType, lostTileId,))
        ...
        self.assertEquals([('tile2', 'plone.app.tiles.demo.persistent'),
                           ('tile4', 'plone.app.tiles.demo.persistent')],
            sorted(list(bookkeeping.enumerate())))
    ...
    def test_transient_lifecycle(self):
        ...
        bookkeeping = ITileBookkeeping(self.folder)
        self.assertEquals([('tile-1', 'plone.app.tiles.demo.transient')],
            list(bookkeeping.enumerate()))
        self.assertEquals([('tile-1', 'plone.app.tiles.demo.transient')],
            list(bookkeeping.enumerate('plone.app.tiles.demo.transient')))
        self.assertEquals('plone.app.tiles.demo.transient',
